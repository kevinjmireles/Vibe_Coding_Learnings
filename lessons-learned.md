...
24. [Simplify. Quantify. Clarify.](docs/024-do-the-math-before-you-build.md) — AI can generate technical detail faster than product managers can absorb it. Put the decision in plain language, show the impact in product numbers, and make asking for clarification easier than approving work you do not really understand.
